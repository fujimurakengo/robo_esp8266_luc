...
void setup(){ 
  ...
  atp.Synthe("sa'-baru kado'kawao /yuru_shicha' dame /'dayo.."); 
  delay(2000);
} 
//////////////////////////////////////////////////////////////////////////////////////////
int prevt = 0; 
...
void speak_orei(int i){
     String orei[3][15]={"waka'ttayo.","pimu,no,moyoo'shio","yukkuritanoshi'nndene?"};
...
void speak_pim(int i){
     String pims[5][25]={"pi'muwa <NUMK VAL=2014>nennni.","ha'ppi-ga,/_tsuku'tta,/bukatsu,da'yo.","ko-ninnsa'-kuru ni na'ttanowa kono/ma'edayo.","i'ma i'_chi ni/nennsei no buinnga ina'ikara boshu-chu-da'yo.","kimimo isshoni _kika'iga/toku'ina fure'nnzuni nara'nai?"};
...
void speak_time(int i){
     String now_time[4][20]={"waka'ttayo.","maka'sete ","imanojika'nnwa imanojika'nnwa ","awawawa'wawa wa wa wa wa wa wa "};//時
...
void speak_lukky(int i){
     String  boss_no_koto[10][20]={"i'i/se'nnsuda.","bo'kuwa,/kabannchannni,_tsukura'reta.","pi'muno,/bu-su,nabige-to',robodayo.","maikonn'wa i-esu'pi-wa/chini-roku'ro_ku.","to-saisareta,se'nnsa-wa.","onn_shitsu'do se'nnsa-.","seidennyo-ryo-'_shiki/taxtu_chise'nnsa.","soreni/kuwaete,onnseigo-se-a'ishi-o/tsunnderuyo.","bo'_ku sugo'idesho?","kabannga,gittoni,bo'kuno/so-_suko'-doo,agetekureteruyo."};               
...
void speak_onditu(int i){
     String  boss_no_koto[10][20]={"i'mano,/o'nndowa.","<NUMK VAL=" + String(t) + " COUNTER=do> ","_shitsu'dowa.","<NUMK VAL=" + String(h) + " COUNTER=pa-> ","dayo!"};               
     atp.Synthe((const char*)& boss_no_koto[i]); 
     delay(100); 
     while(digitalRead(6)==LOW){};
